...
#calc center of the cells to place units
var _half_cell_size = cell_size/2

#Returns position of a cells center in pixless
#place units and move through cells with this function
func calculate_map_position(grid_position: Vector2) -> Vector2:
	return grid_position * cell_size + _half_cell_size
	
#returns coordinates of the cell on the grid given a position
#complementary to calculate_map_position 
